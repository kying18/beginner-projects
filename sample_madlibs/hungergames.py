...
the other twenty-three tributes. Which I have been instructed not to do.".format(
    number=number, verb=verb, verb2=verb2, noun=noun, noun_plural=noun_plural, noun2=noun2, sound_important=sound_important,
    adj=adj, noun_plural_2=noun_plural_2, noun_plural_3=noun_plural_3, noun3=noun3, noun4=noun4, noun5=noun5
)
